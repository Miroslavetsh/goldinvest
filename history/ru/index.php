...
<html>
<head>
<!-- Global site tag (gtag.js) - Google Ads: 805144367 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-805144367"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-805144367');
</script>
...
.style1 {color: #666666}
.стиль4 {color: #666666; font-weight: bold; }
-->
</style></head>
<body>
   <div id="indexLayer1" style="position:absolute;text-align:center;left:1px;top:0px;width:100%;height:3585px;z-index:115;" title="">
       <div id="indexLayer1_Container" style="width:1000px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
         <div id="wb_indexShape3" style="position:absolute;left:67px;top:1626px;width:897px;height:567px;z-index:12;">
            <img src="images/img0011.png" id="indexShape3" alt="" style="border-width:0;width:897px;height:567px;"></div>
         <div id="wb_indexBulletedList1" style="position:absolute;left:79px;top:1649px;width:874px;height:540px;text-align:center;z-index:13;">
            <div>
               <div class="bullet" style="height:46px;">1.</div>
               <div class="item" style="height:46px;text-align:left;"><span style="color:#456474;font-family:'palatino linotype';font-size:15px;"><strong>Выдаём на руки до 80% от рыночной стоимости недвижимости;<br></strong></span></div>
            </div>
            <div style="clear:both">
               <div class="bullet" style="height:148px;">2.</div>
               <div class="item" style="height:148px;text-align:left;"><span style="color:#456474;font-family:'palatino linotype';font-size:15px;"><strong>Минимальная годовая процентная ставка 18% (сопровождается нотариальным оформлением).<br>
              (при минимальной выдаче кредита от 2 000$)<br>
              <br>
               </strong><u>Пример расчёта</u>: При сумме кредита 2 000$, ежемесячная выплата процентов будет всего 30$ (при ставке 1,5% в месяц) без скрытых комиссий и ежеквартальных перерасчётов процента. Итого выплата за год всего: 2 000$ (тело кредита) + 360$ (процент за пользование кредитом) итого 2 360$ за год.<br>
              </span></div>
            </div>
            <div style="clear:both">
               <div class="bullet" style="height:44px;">3.</div>
               <div class="item" style="height:44px;text-align:left;">
                 <div style="line-height:19px;"><span style="color:#456474;font-family:'palatino linotype';font-size:15px;"><strong>Сумма кредита - от 2 000 до 500 000 долларов США;</strong></span></div>
               </div>
            </div>
            <div style="clear:both">
               <div class="bullet" style="height:44px;">4.</div>
               <div class="item" style="height:44px;text-align:left;"><div style="line-height:19px;"><span style="color:#456474;font-family:'palatino linotype';font-size:15px;"><strong>Срок кредитования - от 3х до 60ти месяцев с возможностью пролонгации;</strong></span></div>
               </div>
            </div>
            <div style="clear:both">
...
&nbsp;</div>
               ...
               <div id="wb_indexText33" style="position:absolute;left:522px;top:298px;width:24px;height:42px;text-align:center;z-index:8;"><span class="стиль2">7</span></div>
         ...
         <div id="wb_indexText10" style="position:absolute;left:187px;top:3066px;width:166px;height:22px;z-index:62;text-align:left;">
            <span style="color:#456474;font-family:'palatino linotype';font-size:16px;">Продавец, г.Москва </span></div>
         ...
         <div id="wb_indexText49" style="position:absolute;left:484px;top:3063px;width:174px;height:22px;z-index:67;text-align:left;">
            <span style="color:#456474;font-family:'palatino linotype';font-size:16px;">Бизнесмен, г.Балашиха</span></div>
         ...
         <div id="wb_indexText51" style="position:absolute;left:780px;top:3063px;width:170px;height:22px;z-index:72;text-align:left;">
            <span style="color:#456474;font-family:'palatino linotype';font-size:16px;">Бухгалтер, г.Мытищи</span></div>
         ...
         <div id="wb_indexText3" style="position:absolute;left:463px;top:12px;width:225px;height:60px;text-align:center;z-index:77;">
            <span style="color:#505050;font-family:'palatino linotype';font-size:24px;">+7 (495) 145-32-05</span><br>
         <span class="стиль4">boguslav.invest@gmail.com</span></div>
         ...
         <div id="wb_indexImage5" style="position:absolute;left:725px;top:1969px;width:186px;height:191px;z-index:80;">
...
<div id="indexLayer2" style="position:absolute;text-align:center;left:0px;top:75px;width:100%;height:577px;z-index:116;" title="">
      <div id="indexLayer2_Container" style="width:1000px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
         ...
         <div id="wb_indexText4" style="position:absolute;left:57px;top:95px;width:435px;height:114px;text-align:center;z-index:85;">
            <span style="color:#e9967a;font-family:'arial black';font-size:27px;">СРОЧНО НУЖНЫ НАЛИЧНЫЕ ПОД<br>ЗАЛОГ НЕДВИЖИМОСТИ ?</span></div>
         <div id="wb_indexText18" style="position:absolute;left:782px;top:51px;width:172px;height:28px;z-index:86;text-align:left;">
            <span style="color:#ffffff;font-family:'palatino linotype';font-size:21px;">от</span><span class="стиль1"> 1,5 % в мес. </span></div>
         <div id="wb_indexText20" style="position:absolute;left:68px;top:15px;width:464px;height:46px;text-align:center;z-index:88;">
            <span style="color:#ffffff;font-family:'palatino linotype';font-size:17px;">Кредит под залог недвижимости в Москве и области. <br>
        Под квартиру, дом, офис.</span></div>
         <div id="wb_indexImage3" style="position:absolute;left:179px;top:4px;width:720px;height:572px;z-index:89;">
            <img src="images/deva1.png" id="indexImage3" alt="" style="width:720px;height:572px;"></div>
      </div>
      <div id="div" style="width:1000px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
        <div id="layer" style="position:absolute;left:128px;top:251px;width:308px;height:56px;z-index:84;text-align:left;"> <span style="color:#e6e6fa;font-family:'palatino linotype';font-size:21px;">Заполните заявку и получите Ваши деньги через 3-часа</span></div>
        <div id="layer2" style="position:absolute;left:57px;top:95px;width:435px;height:114px;text-align:center;z-index:85;"> <span style="color:#e9967a;font-family:'arial black';font-size:27px;">СРОЧНО НУЖНЫ НАЛИЧНЫЕ ПОД<br>
          ЗАЛОГ НЕДВИЖИМОСТИ ?</span></div>
        <div id="layer3" style="position:absolute;left:782px;top:51px;width:172px;height:28px;z-index:86;text-align:left;"> <span style="color:#ffffff;font-family:'palatino linotype';font-size:21px;">от</span><span class="стиль1"> 1,5 % в мес. </span></div>
        <div id="layer4" style="position:absolute;left:68px;top:15px;width:464px;height:46px;text-align:center;z-index:88;"> <span style="color:#ffffff;font-family:'palatino linotype';font-size:17px;">Кредит под залог недвижимости в Москве и области. <br>
          Под квартиру, дом, офис.</span></div>
        <div id="layer5" style="position:absolute;left:179px;top:4px;width:720px;height:572px;z-index:89;"> <img src="images/deva1.png" id="indexImage3" alt="" style="width:720px;height:572px;"></div>
      </div>
   </div>
   <div id="indexLayer3" style="position:absolute;text-align:center;left:0px;top:3451px;width:100%;height:130px;z-index:117;" title="">
      <div id="indexLayer3_Container" style="width:1002px;position:relative;margin-left:auto;margin-right:auto;text-align:left;">
         ...
         <div id="wb_indexText42" style="position:absolute;left:397px;top:109px;width:212px;height:20px;text-align:right;z-index:105;">
            <span style="color:#000000;font-family:'trebuchet ms';font-size:15px;">@ 2018. Все права защищены</span></div>
         <div class="style1" id="wb_indexText14" style="position:absolute;left:130px;top:35px;width:193px;height:51px;text-align:center;z-index:107;">
           <div align="center"><strong>Москва, ул.Коровий Вал,5</strong> м.Добрынинская, +7(495)145-32-05 </div>
        </div>
         <div id="wb_indexText46" style="position:absolute;left:130px;top:87px;width:185px;height:18px;text-align:center;z-index:108;"><span style="color:#505050;font-family:'palatino linotype';font-size:13px;"><strong>boguslav.invest@gmail.com</strong></span></div>
         <div id="wb_indexText44" style="position:absolute;left:652px;top:6px;width:297px;height:36px;z-index:109;text-align:left;">
            <span style="color:#505050;font-family:'palatino linotype';font-size:13px;">Кредит под залог недвижимости.<br>Квартиры, дома, коммерческая недвижимость.</span></div>
