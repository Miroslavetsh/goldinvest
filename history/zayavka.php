...
<body>
   <div id="container">
      <div id="wb_Shape10" style="position:absolute;left:85px;top:16px;width:457px;height:361px;z-index:4;">
         <img src="images/img0017.png" id="Shape10" alt="" style="border-width:0;width:457px;height:361px;">
      </div>
      ...
      <div id="wb_Form2" style="position:absolute;left:158px;top:106px;width:299px;height:235px;z-index:6;">
         <form name="Form1" method="post" action="send_message.php" enctype="multipart/form-data" id="Form2">
            <input type="text" id="Editbox4" style="position:absolute;left:35px;top:14px;width:220px;height:35px;line-height:35px;z-index:0;" name="client_name" value="" placeholder="&#1042;&#1072;&#1096;&#1077; &#1080;&#1084;&#1103;*">
            <input type="submit" id="Button3" name="" value="" style="position:absolute;left:58px;top:168px;width:177px;height:51px;z-index:1;">
            <input type="tel" id="Editbox5" style="position:absolute;left:35px;top:63px;width:220px;height:36px;line-height:36px;z-index:2;" name="client_phone" value="" placeholder="&#1042;&#1072;&#1096; &#1090;&#1077;&#1083;&#1077;&#1092;&#1086;&#1085;*">
