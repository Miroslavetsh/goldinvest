<?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST')
   {
      ...
      $subject = 'Нижняя заявка на бизнес-кредит:';
   ...
   <div id="container">
      ...
      <div id="wb_Form2" style="position:absolute;left:158px;top:106px;width:299px;height:235px;z-index:6;">
         <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" id="Form2">
            ...
            <input type="text" id="zayavkaEditbox1" style="position:absolute;left:34px;top:115px;width:220px;height:36px;line-height:36px;z-index:3;" name="На что нужны деньги" value="" placeholder="&#1053;&#1072; &#1095;&#1090;&#1086; &#1085;&#1091;&#1078;&#1085;&#1099; &#1076;&#1077;&#1085;&#1100;&#1075;&#1080;*">
         </form>
      </div>
   </div>
