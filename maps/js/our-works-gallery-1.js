...
(function () {
  try {
    const textContent = [
      {
        title: "2х.к. Квартира. Академіка Сахарова",
        price: "25 000 $",
        description:
      ...
      {
        title: "Заміський будинок. вул. Толбухіна",
        price: "100 000 $",
        description:
          "Звернувся індивідуальний підприємець, який активно працює із кредитами під заставу нерухомості для бізнесу. Оцінку будинку та ділянки проведено незалежним оцінювачем. Схвалено 100 000 $ на три роки. Були додаткові перевірки: з'ясувалося, що на ділянці є незареєстрована споруда,
яку довелося або оформити, або потрібно було знизити оцінну вартість. Позичальник оперативно оформив будівництво. Підписано пакет документів: кредитний договір, договір застави. Кошти видано позичальнику після завершення всіх реєстраційних дій.",
      },
      {
        title: "Кімната в комунальній квартирі, вул.Паустовського",
        price: "7 000 $",
        description:
          "Пенсіонерка потребує грошей на дорозі лікування. Позичальниця звернулася за кредитом під заставу кімнати. Враховуючи вік та специфіку об'єкта, пред'явили суворіші вимоги до прибутковості та інших забезпечень. Дохід заемщика був частично підтверджений пенсією та допомогою від дітей. Схвалили суму кредиту 7000$, щоб мінімізувати ризики. Було проведено детальну перевірку документів на кімнату: договір купівлі-продажу, відсутність переважного права купівлі у інших власників.
Підписано кредитний договір. Оскільки квартира комунальна, заемщик передала до застави лише свою кімнату, що було відображено у договорі застави. Реєстрація застави пройшла стандартно. Кошти були видані готівкою, що було зручно для заемщика.",
      },
      {
        title: "Нежитлове приміщення (комерційна нерухомість), вул.Таїрова",
        price: "75 000 $",
        description:
      ...
      {
        title: "3-к.кв., Приморський район",
        price: "50 000 $",
        description:
